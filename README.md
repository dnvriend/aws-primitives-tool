...
<p align="center">
  <img src=".github/assets/logo.png" alt="AWS Primitives Tool Logo" width="300">
</p>
...
`aws-primitives-tool` is a Python CLI tool built with modern tooling and best practices.
...
git clone https://github.com/dnvriend/aws-primitives-tool.git
cd aws-primitives-tool
...
make run ARGS="..."   # Run aws-primitives-tool locally
...
```
aws-primitives-tool/
├── aws_primitives_tool/    # Main package
│   ├── __init__.py
...
# Run with coverage
uv run pytest tests/ --cov=aws_primitives_tool
```
